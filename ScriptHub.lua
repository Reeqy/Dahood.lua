...
Strucid.Position = UDim2.new(0.661691546, 0, 0.0773480684, 0)
Strucid.Size = UDim2.new(0, 187, 0, 50)
Strucid.Font = Enum.Font.GothamBlack
...
Strucid.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Reeqy/Dahood.lua/main/Strucid.lua"))()
end)
...
Phantom.Position = UDim2.new(0.661691546, 0, 0.156077355, 0)
Phantom.Size = UDim2.new(0, 187, 0, 50)
Phantom.Font = Enum.Font.GothamBlack
Phantom.Text = "Phantom Forces"
Phantom.TextColor3 = Color3.fromRGB(0, 0, 0)
Phantom.TextSize = 14.000
Phantom.MouseButton1Down:connect(function()
	loadstring(game:HttpGet"https://raw.githubusercontent.com/Reeqy/Dahood.lua/main/Phantom.lua")()
end)
